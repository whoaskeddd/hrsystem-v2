  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="max-w-md rounded-shell border border-white/8 bg-elevated/90 p-8 text-center shadow-card">
        ...
        <p className="mt-4 text-secondary">Маршрут не существует или ссылка устарела. Основные пользовательские и служебные сценарии уже доступны через навигацию.</p>
        <Link
          to="/"
